...
```
https://maps.googleapis.com/maps/api/directions/json?origin=Lindsay+ON&destination=Quebec+City+ON&waypoints=Ottawa+ON|Montreal+QC&avoid=tolls|highway&mode=driving&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE
```
